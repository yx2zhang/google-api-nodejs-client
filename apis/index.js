...
var APIs = {
  ...
  'proximitybeacon': requireAPI('proximitybeacon'),
  'pubsub': requireAPI('pubsub'),
  'script': requireAPI('script'),
  'storagetransfer': requireAPI('storagetransfer'),
  'youtubereporting': requireAPI('youtubereporting'),
